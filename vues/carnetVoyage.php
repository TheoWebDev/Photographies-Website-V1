...
<html lang="fr">
  <head>
    <title>TH_Photographies_CT</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="row">
                <div class="col-12 col-sm-4 p-3 contentImgGaleries" data-aos="zoom-in" data-aos-duration="1000">
                    <a href="/vues/nyc.php"><img src="../assets/img/carnetNyc.jpg" alt="" class="imgSectionCarnet"></a>
                    <p class="text-center pt-2">New-York City | Hiver 2019</p>
                </div>
                <div class="col-12 col-sm-4 p-3 contentImgGaleries" data-aos="zoom-in" data-aos-duration="1000">
                    <img src="../assets/img/carnetMiami.jpg" alt="" class="imgSectionCarnet">
                    <p class="text-center pt-2">Miami-Beach | Hiver 2018</p>
                </div>
                <div class="col-12 col-sm-4 p-3 contentImgGaleries" data-aos="zoom-in" data-aos-duration="1000">
                    <img src="../assets/img/carnetQuebec.jpg" alt="" class="imgSectionCarnet">
                    <p class="text-center pt-2">Québec | Automne 2014</p>
                </div>
            </div>
        </div>
    </div> <!-- END row -->
