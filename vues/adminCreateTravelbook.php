...
<body class="adminPage">
    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-center align-items-center">
            ...
            <?php
            // Condition pour ne plus afficher le formulaire quand le récit a été crée.
            if (!$addNewTravelbookInBase) { ?>

            <?php
                // Include pour la mise en place du formulaire form-createTravelbook.
                include "include/form-createTravelbook.php";
            } else { ?>
                <!-- Si le récit a bien été crée, je l'indique via un message -->
                <div>
                    <p class="h4 mt-5 paraCreateElement"><?= $errorMessages['addNewTravelbook'] ?? '' ?></p>
                    <p class="h4 mt-5 paraCreateElement">Votre récit <span class="font-weight-bold"><?= $_POST['titleTravelbook'] ?></span> a bien été publié !</p>
                    <div class="mt-5 d-flex justify-content-center">
                        <a type="button" href="adminHome.php" class="btn btn-secondary mr-1">tableau de bord</a>
                        <a type="button" href="adminCreateTinymce.php" class="btn btn-primary ml-1">écrire le récit</a>
                    </div>
                </div>
