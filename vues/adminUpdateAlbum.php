...
require_once "../controllers/controller_adminUpdateAlbum.php";
...
<body class="adminPage">
   ...
   <div class="container-fluid">
      ...
      <div class="row justify-content-center align-items-center">
         ...
         <?php
         // Si modifyAlbum n'est pas vide = nous venons bien de la page adminImginAlbums
         ...
         <?php
            // Si aucune condition n'est remplie = l'utilisateur a directement saisi l'URL, nous lui indiquons via un message
